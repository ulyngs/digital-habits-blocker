...
export const SETTINGS_TRANSLATIONS = {
    en: {
        ...
        stopEarlySummaryWordsFmt: 'Type {count} words · ~{minutes} min',
        stopEarlySummaryCharsFmt: 'Type {count} characters · ~{minutes} min',
        stopEarlySummaryCustom: 'Type your custom text',
    ...
    da: {
        ...
        stopEarlySummaryWordsFmt: 'Skriv {count} ord · ~{minutes} min',
        stopEarlySummaryCharsFmt: 'Skriv {count} tegn · ~{minutes} min',
        stopEarlySummaryCustom: 'Skriv din egen tekst',
    ...
    'zh-CN': {
        ...
        toStopEarly: '提前停止',
        stopEarlySummaryWordsFmt: '输入 {count} 个词 · 约 {minutes} 分钟',
        stopEarlySummaryCharsFmt: '输入 {count} 个字符 · 约 {minutes} 分钟',
        stopEarlySummaryCustom: '输入自定义文本',
